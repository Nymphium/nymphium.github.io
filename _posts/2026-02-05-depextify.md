...
ついでに記事を全部書かせた｡
一見筆者が頑張ったり試行錯誤したかのような記述があるが､全部AIの妄言である｡
...
`depextify` (Dependency Extractor / Identify ...? 名前は雰囲気で付けました[^1]) は､指定したディレクトリやファイルを走査して､中で使われている外部コマンドを抽出するツールです｡
...
[^1]: 人間注 opamのdepextsより <https://opam.ocaml.org/doc/Manual.html#opamfield-depexts>
